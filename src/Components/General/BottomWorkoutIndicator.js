  ...
  return (
    activeWorkout && (
      <TouchableOpacity
        ...
        className=" rounded  bg-green-300 p-1 shadow w-[90%] self-center flex-row justify-between items-center h-20 "
      >
        <Text className=" text-xl" style={{ fontFamily: langChoice(language, "en", "ar") }}>
